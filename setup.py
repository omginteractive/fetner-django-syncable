...
filename = os.path.join(os.path.dirname(__file__), 'syncable', 'pkgmeta.py')
pkgmeta = {}
exec(open(filename).read(), pkgmeta)
...
setup(
    ...
    license='MIT',
    url='http://github.com/hzdg/django-syncable',
